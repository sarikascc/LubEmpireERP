...
export default function AddFinishedProductModal() {
  ...
  const glassModal =
    "bg-[#f4f5f7]/95 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.1)] rounded-3xl w-full max-w-md flex flex-col max-h-[90vh] overflow-hidden";
  const glassInput =
